...
interface ChangeAuthPageType {
  title: 'Tizimga' | "Hisobinggiz yo'qmi?";
}
  ...
  return (
    <p className="mt-5 space-x-1 text-center text-sm text-slate-300">
      ...
      <Link
        ...
        className="font-medium hover:scale-[1.1] inline-block duration-300 text-indigo-300 hover:text-indigo-200"
      >
        {title == 'Tizimga' ? 'Kirish' : "Ro'yxatdan otish"}
      </Link>
    </p>
  );
};
